...
function Formulario({ onAgregarTarjeta }) {
    ...
    // en el tag del boton se le agrega el evento type="submit" para que se ejecute la funcion handleChange al momento de enviar el formulario
        <div class="one-half column">
            <h2>Crear mi Cita</h2>
            <form onSubmit ={handleChange} ><label>Nombre Mascota</label><input type="text" name="mascota" className="u-full-width" placeholder="Nombre Mascota"
                value="" /><label>Nombre Dueño</label><input type="text" name="propietario" className="u-full-width"
                    placeholder="1 dueño de la mascota" value="" /><label>Fecha</label><input type="date" name="fecha"
